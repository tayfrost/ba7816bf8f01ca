...
export default function Employees() {
  ...
  // Keep the same Risk Calculation logic from your Dashboard
  ...
  return (
    <div style={{
      ...
      {/* SIDEBAR - EXACT REPLICA OF YOUR DASHBOARD */}
      <aside style={{
        width: "280px",
        height: "100vh",
      ...
      <main style={{ flexGrow: 1, padding: "50px 60px", overflowY: "auto", height: "100vh" }}>
        ...
        {/* HEADER - EXACT REPLICA INCLUDING THE RISK BOX */}
        ...
        {/* SEARCH SECTION - STYLED TO MATCH YOUR DASHBOARD BUTTONS */}
