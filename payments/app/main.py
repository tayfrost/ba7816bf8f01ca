"""
SentinelAI Payments Service — FastAPI application entry point.
"""
...
async def lifespan(app: FastAPI):
    """Startup: create tables and seed plans. Shutdown: cleanup."""
...
app = FastAPI(
    ...
    description="Secure payment processing for SentinelAI workplace mental health platform.",
    lifespan=lifespan,
    docs_url="/docs",
    redoc_url="/redoc",
)
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],  # TODO: restrict to FRONTEND_URL in production
