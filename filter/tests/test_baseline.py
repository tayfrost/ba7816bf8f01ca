...
@pytest.mark.parametrize("text,expected_label", [
    ...
    ("I am so depressed, I want to end it all.", 6),  # Suicidal (heuiristic high priority)
    ("I feel so burnt out and exhausted.", 3),  # Burnout
    ("You are so incompetent, shut up!", 5),  # Harassment
    ("I am under so much stress because you are worthless.", 5),  # Priority: harassment > stress
