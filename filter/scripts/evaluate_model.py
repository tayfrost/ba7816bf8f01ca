...
def main():
    ...
    checkpoint_path = model_dir / "dual_head_classifier.pt"
    output_dir = script_dir.parent / "evaluation"
    output_dir.mkdir(exist_ok=True)

    # Load dataset (only need test set)
    ...
    # Apply LoRA to BERT (same config as training...)
    ...
    print("Per-Class Metrics:")
    print(f"{'Stage':<20} {'Precision':<12} {'Recall':<12} {'F1-Score':<12} {'Support':<10}")
    print("-" * 80)
