...
def quantize_to_dynamic_int8(
    ...
    print(f"[DYNAMIC INT8] Running shape inference...")
...
def quantize_to_static_int8(
    ...
    print(f"[STATIC INT8] Running quantization with calibration...")
...
def main():
    ...
    base_model_path = models_dir / "sentinelai_model.onnx"
    ...
    # Output paths
    fp16_path = models_dir / "sentinelai_model_fp16.onnx"
    dynamic_int8_path = models_dir / "sentinelai_model_dynamic_int8.onnx"
    static_int8_path = models_dir / "sentinelai_model_static_int8.onnx"
    
    # Load validation data for static quantization calibration
    print(f"\n[DATA] Loading validation dataset for calibration...")
    dataset_path = str(config.DATASETS_DIR / "sentinelai_dataset_v0.3.json")
    ...
    try:
        ...
        print(f"[DATA] ✓ Validation data loaded")
